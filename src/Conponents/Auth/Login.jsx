                ...
                signState === "Recover Your Account" ?
                  ...
                  <div className="inputs">
                    ...
                    <div className="input">
                      ...
                      />
                      <img className="bk" src={emailImage} alt="" />
                    </div>
                    ...
                    <div className="input">
                      ...
                      <input type="password" name="password"
                        ...
                        id="password" />
                      <img className="bk" src={passwordHidden} alt="" /> <br />
                      {signState === "Create an account" ?
                        <></> :
                        <span className="forget">Dont remember? <a className="forgetloginpass" onClick={() => { setSignState("Recover Your Account")} } >Forget Password</a></span>
                      }
                    </div>
